...
No model-based Activation Eval has been run or claimed for `0.1.0-alpha.3`. No fixture pass is evidence of semantic activation quality. A future eval gate may change support or bundle metadata only after its results are reviewed; deterministic fixture validation remains necessary but is not sufficient.
